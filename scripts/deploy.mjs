...
function deployWorker() {
  ...
  return spawnSync(
    ...
    [
      ...
      "--set-env-vars",
      `FIRESTORE_CONVERSATION_COLLECTION=${conversationCollection},MEDIA_TASK_SERVICE_ACCOUNT=${taskServiceAccount},MEDIA_TASK_QUEUE=${queue},MEDIA_WORKER_AUDIENCE=https://placeholder.invalid`,
      "--quiet",
    ],
    { stdio: "inherit" },
  );
